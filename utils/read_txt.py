...
# datetime:2022/1/8 0:04
# software: PyCharm

"""
文件说明：
    版本1.0 对训练以及评估过程中生成的文本文件进行数据提取
"""

# 读取位姿训练评估的txt数据，返回三个列表，分别是epoch, RMSE, error
...
def get_poss_data(eval_list:list, file_path:str):
    ...
    return pose_loss_data, save_epoch_set  #  pose_loss_data 是传给excel的数据，save_epoch_set是出现最好结果的epoch集合
